...
package body Gnoga.Gui.Plugin.Message_Boxes is
   ...
   is
      ...
      --
      procedure OK_Close_Dialog
        (Object : in out Gnoga.Gui.Base.Base_Type'Class);
      procedure No_Close_Dialog
        (Object : in out Gnoga.Gui.Base.Base_Type'Class);
      procedure Cancel_Close_Dialog
        (Object : in out Gnoga.Gui.Base.Base_Type'Class);
      procedure Cancel_Window_Dialog
        (Object : in out Gnoga.Gui.Base.Base_Type'Class);
   ...
   begin
      ...
      case Style is
         when OK_Box =>
            ...
            jQueryUI.Position
                    (ok_btn.all,
                     Target   => Dialog,
                     Using_My => "center bottom",
                     At_Target => "center bottom");
         when others =>
      ...
      case Style is
         ...
         when others =>
            no_btn := Common.Button_Access
              (Dialog.New_Element ("no", new Common.Button_Type));
      ...
      case Style is
         when Yes_No_Cancel_Box |
            ...
            cancel_btn := Common.Button_Access
              (Dialog.New_Element ("cancel", new Common.Button_Type));
            cancel_btn.Create (Dialog, "Cancel");
            cancel_btn.On_Click_Handler
              (Cancel_Close_Dialog'Unrestricted_Access);
            jQueryUI.Position
              (cancel_btn.all,
               Target   => Dialog,
               Using_My => "right bottom",
               At_Target => "right bottom");
         when others =>
